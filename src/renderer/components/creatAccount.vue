  ...
  <div id="accountWrapper" v-if="isRouterAlive">
    ...
    <div id="stepPage">
      ...
      <div id="step2" v-show="creat_page == 1">
        ...
        <p class="title alt small"> Please back up the recovery phrase now. Make sure to keep it private and secure, it allows full and unlimited access to the account. </p>
      </div>
